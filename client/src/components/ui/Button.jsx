...
//   console.log(bttype);
  ...
  <div className={`flex items-center ${outcls}`}>
    <div className="relative group">
        ...
        >
            <span
                className="absolute inset-0 rounded-xl bg-gradient-to-r from-teal-400 via-blue-500 to-purple-500 p-[26px] opacity-0 transition-opacity duration-500 group-hover:opacity-100"
            ></span>

            <span className="relative z-10 block px-6 py-3 rounded-xl bg-a-green">
